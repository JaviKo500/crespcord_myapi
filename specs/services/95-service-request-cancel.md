...
```json
{
  ...
  "data": {
    "service_request": {
      ...
      "offers_count": 4,
      "assigned_offer": { "id": 52, "status": "rejected", "amount": 150.5, "...": "las quince claves de una oferta" },
      "assigned_provider": { "id": 9, "title": "Plomería Ruiz", "...": "las ocho claves de una tarjeta de proveedor" },
